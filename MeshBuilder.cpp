...
MeshBuilder::MeshBuilder(const vector<K2::Triangle_3>&generate_face_final, K2::Point_3 grid_min, K2::Point_3 grid_max,vector<K2::Point_3>ext_v,double merge_eps){
